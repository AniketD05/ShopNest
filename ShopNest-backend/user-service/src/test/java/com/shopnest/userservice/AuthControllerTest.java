...
import com.shopnest.userservice.controller.AuthController;
...
class AuthControllerTest {
    ...
    void register_success() throws Exception {
        ...
        req.setUsername("aniket");
        req.setEmail("aniket@gmail.com");
    ...
    void login_success() throws Exception {
        ...
        req.setUsernameOrEmail("aniket");
        req.setPassword("12345");

        AuthResponse resp = new AuthResponse("dummy-jwt-token");
